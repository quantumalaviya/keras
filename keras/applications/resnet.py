...
def block0(x, filters, kernel_size=3, stride=1, conv_shortcut=True, name=None):
  ...
  x = layers.Conv2D(
      filters, kernel_size, padding='SAME', strides=stride, name=name + '_1_conv')(x)
...
@keras_export('keras.applications.resnet18.ResNet18',
              'keras.applications.resnet.ResNet18',
...
@keras_export('keras.applications.resnet34.ResNet34',
              'keras.applications.resnet.ResNet34',
